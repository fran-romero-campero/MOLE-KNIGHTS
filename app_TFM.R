  ...
  fluidRow(
    ...
    column(
      ...
      conditionalPanel(condition = "input.navigation_bar == 'github'",
        ...
        source code is released under", tags$b("MIT License"), "and is hosted at",
                                tags$b("GitHub."), "If you experience any problem using MOLE KNIGHTS please create an", 
                                tags$b(tags$a(href="https://github.com/sandungxs/TFM/issues","issue")), 
                                "in GitHub and we will address it."),
                       tags$div(align="center",tags$h1(tags$b(tags$a(href="https://github.com/sandungxs/TFM",
